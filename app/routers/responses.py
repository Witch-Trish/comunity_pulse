...
# creating a function to get responses with method "GET"
@responses_bp.route('/', methods=['GET'])
def get_responses():
    responses = Response.query.all()
    serialized = ([ResponseSchema(question_text=r.question.text, is_agree=r.is_agree,
                                  question_id=r.question.id, id=r.id).model_dump() for r in responses])
...
# creating a function to get response by ID
...
# creating a function to delete a response by ID
